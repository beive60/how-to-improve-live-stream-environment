...
**優先度スコア** = (検索需要 x 2) + (制作容易性 x 1) + (差別化効果 x 1.5) + (アルゴリズム適合性 x 1.5)
...
<!--
Phase 1（9本）の中での制作順序を決めるための評価です。
...
| 期間（目安） | Phase | 制作本数 | 目標 |
| --- | --- | --- | --- |
| 1-6ヶ月目 | Phase 1 | 10本 | 検索流入の確保とチャンネル方向性の確立 |
